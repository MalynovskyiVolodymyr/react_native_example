  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 20 }}>
      <View style={styles.componentsSection}>
        ...
        <View style={{ height: 1, alignSelf: 'stretch', backgroundColor: Colors.bluish }} />
      ...
      <View style={styles.componentsSection}>
        ...
        <View style={styles.demoButtonsContainer}>
          <Button
            ...
            onPress={this.buttonClicked}
          >
            <Text><Icon name="chevron-thin-right" size={20} color="white" /></Text>
          </Button>
          <Button
            ...
            onPress={this.buttonClicked}
          >
            <Text><Icon name="controller-paus" size={20} color="white" /></Text>
          </Button>
          <Button
            style={styles.demoActionButton}
            action
            ...
            onPress={this.buttonClicked}
          >
            <Text><Icon name="magnifying-glass" size={20} color="white" /></Text>
          </Button>
          <Button
            style={styles.demoActionButton}
            action
            ...
            onPress={this.buttonClicked}
          >
            <Text><Icon name="paper-plane" size={20} color="white" /></Text>
          </Button>
          <Button
            style={styles.demoActionButton}
            action
            ...
            onPress={this.buttonClicked}
          >
            <Text><Icon name="flash" size={20} color="white" /></Text>
          </Button>
          <Button
            style={styles.demoActionButton}
            action
